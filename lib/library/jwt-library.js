...
function checkJwtTimeValidity(keyType, tokenString) {
    var _a;
    const data = parseJwt(keyType, tokenString);
    const type = data === null || data === void 0 ? void 0 : data.sub;
    const expTime = (_a = data === null || data === void 0 ? void 0 : data.exp) !== null && _a !== void 0 ? _a : 0;
